...
import { VendorFormValues } from "../VendorForm/VendorForm";
import { VendorLocation } from "../VendorLocationForm/VendorLocationForm";
    ...
    <CustomContentContainer>
      <div className="flex flex-col gap-y-2">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <TitleTextBlock label={tempVendorDetails.country} title={"Country"} />
        </div>
        <hr />
      </div>
